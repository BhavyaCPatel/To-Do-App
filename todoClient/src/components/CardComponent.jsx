...
const CardComponent = ({ data, onCheckboxChange }) => {
    ...
    const footer = (
        <div className="flex align-items-center">
            ...
            />
            <Button icon="pi pi-pen-to-square" className='bg-transparent text-green-600 border-0' />
            <Button icon="pi pi-trash" className='bg-transparent text-red-600 border-0' />
        </div>
    );
    ...
    return (
        <div className="content card flex justify-content-center p-4">
            <Card footer={footer} header={header} className="md:w-25rem pt-0">
                <p className='px-1 py-1 mt-0 italic'>{dueDate}</p>
                <p className="m-0 text-xl font-medium">
                    {data.description}
                </p>
                <div className="flex pt-4 text-sm italic">
